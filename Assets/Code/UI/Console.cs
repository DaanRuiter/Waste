...
namespace Mythic
{
    ...
    public class CMD : MonoBehaviour
    {
        ...
        /// <returns>Info of the message</returns>
        public static ConsolePrintInfo Warning (object message)
        {
            return CreatePrintInfo(LogType.Warning, message.ToString());
        }
        /// <summary>
        ...
        /// <returns>Info of the message</returns>
        public static ConsolePrintInfo Error (object message)
        {
            if (m_openConsoleOnError)
                ToggleConsole(true);
            return CreatePrintInfo(LogType.Error, message.ToString(), Environment.StackTrace);
        }
        /// <summary>
